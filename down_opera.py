...
# Mescelleneouse 클릭
gui.moveTo(1208, 183, duration=1)
gui.click()

# Reports 버튼 더블클릭
gui.moveTo(365, 261, duration=1)
gui.click()
gui.sleep(2)

# 검색창 입력
gui.moveTo(725, 305, duration=1)
gui.click()
...
# file format 선택 : XML
gui.moveTo(1027, 673, duration=1)
gui.click()
...
gui.hotkey('alt', 'f')
gui.sleep(1)
gui.moveTo(692, 546, duration=1)
gui.doubleClick()
gui.sleep(1)

target_file_name = 'trial_balance' + target_date
gui.write(target_file_name, interval=0.4)
gui.sleep(2)
gui.moveTo(1005, 547, duration=1)
gui.click()
gui.sleep(2)
...
target_file_name = 'C:/users/fa2/' + target_file_name + '.xml'
shutil.move(target_file_name, down_base_dir)